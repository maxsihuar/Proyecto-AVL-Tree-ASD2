...
namespace BibliotecaGrafica
{
    public partial class Form_Buscar : Form
    {
        ...
        public Form_Buscar(string Objeto, Form2 Anterior)
        {
            ...
            InitializeComponent();
            Titulo.Text = $" {"BUSCAR " + ObjetoSeleccionado.ToUpper()}";
        ...
        private void Buscar_Click(object sender, EventArgs e)
        {
            ...
            if (ObjetoSeleccionado == "Libro")
            {
                ls = control.BuscarObjeto(arbolLibros, id);
            ...
            {
                ls = control.BuscarObjeto(arbolLectores, id);
            ...
            {
                ls = control.BuscarObjeto(arbolPrestamos, id);
